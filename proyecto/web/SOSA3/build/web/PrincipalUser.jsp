...
<div class="allcontain">
	<div class="header">
			...
			<ul class="givusacall"><br>
                                ...
                                <li>Bienvenido al sistema...<strong>Usuario: ${dni}</strong></li>
			</ul>
                        <ul class="logreg">
	...
	<nav class="topnavbar navbar-default topnav">
		...
		<div class="collapse navbar-collapse" id="upmenu">
			<ul class="nav navbar-nav" id="navbarontop">
                                <button onclick="window.location.href='ControladorAgregarReservas?accion=add'">
                                <span class="postnewcar">ALQUILAR UNA MAQUINA</span>
                                </button>
                                <button onclick="window.location.href='ControladorHabitacionesVista?accion=listar'">
                                <span class="postnewcar">DISPONIVILIDAD DE MAQUINAS</span>
                                </button>
                                <button onclick="window.location.href='ControladorReservas?accion=listarUsuario'">
                                <span class="postnewcar">SEGUIMIENTO DE MAQUINA</span>
                                </button>
