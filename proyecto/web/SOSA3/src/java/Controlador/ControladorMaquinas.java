 ...
 * @author USUARIO
 */
public class ControladorMaquinas extends HttpServlet {
    
    
    String Listar="VistaMaquinas/listar.jsp";
    String add="VistaMaquinas/agregar.jsp";
    String edit="VistaMaquinas/editar.jsp";
