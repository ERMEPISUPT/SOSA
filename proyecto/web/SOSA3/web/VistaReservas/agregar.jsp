...
<head>
    ...
    <title>Agregar Alquiler de Maquina</title>
...
<body>
    <div class="container">
        <h1 class="mt-4">AGREGAR ALQUILER</h1>
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
            <label for="txth_id" class="form-label">MAQUINAS:</label>
            ...
            <p id="p-message"></p>
            <div class="form-group">
                <label for="txtf_re" class="form-label">FECHA ACTUAL:</label>
...
<!--        <input type="submit" class="btn btn-primary" name="accion" value="Agregar" onclick="mostrarAlerta()">-->
    ...
    function calcularDiferencia() {
        ...
        var select = document.getElementById('txth_id');
        var precio = parseFloat(select.options[select.selectedIndex].dataset.price);
        
        // Calcular el precio total a pagar
        var precioTotal = diferenciaEnDias * precio;
    ...
    <script>
        ...
        Select.addEventListener('change', calcularDiferencia);
        Select.addEventListener('change',function(){
            var disponible = this.options[this.selectedIndex].dataset.enable;
            ...
            if(disponible == "Disponible"){
                ...
                document.querySelector("#p-message").innerText = "Maquina en uso.."
            }
        })
    </script>
