        ...
        <table class="table mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= res.getPtotal() %></td>
                    <td class="actions">
                        <a class="btn btn-secondary" href="./pdf_1.jsp?&id=<%= res.getId() %>">pdf</a>
                    </td>
                </tr>
                <% } %>
            </tbody>
        </table>
        <a href="./PrincipalUser.jsp" class="btn btn-primary">Regresar</a>
    </div>
