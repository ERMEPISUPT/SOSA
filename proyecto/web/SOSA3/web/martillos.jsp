...
<div class="allcontain">
	<div class="header">
			...
			<ul class="givusacall"><br>
				...
				<li><a href="ControladorAgregarUsuarios?accion=add"><span class="register">Register</span></a></li><br>
			</ul>
	</div>
	<!-- Navbar Up -->
			...
			<ul class="nav navbar-nav" id="navbarontop">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdowncostume">
						<li><a href="cargadores.jsp">CARGADORES</a></li>
						<li><a href="martillos.jsp">MARTILLOS NEUMATICOS</a></li>
						<li><a href="index.jsp">RETROEXCAVADORAS</a></li>
                                                <li><a href="camionetas.jsp">CAMIONETAS 4X4</a></li>
						<li><a href="compresoras.jsp">COMPRESORAS</a></li>
					</ul>
				</li>
				<li>
